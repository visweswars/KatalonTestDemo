...
Mobile.tap(findTestObject('Object Repository/aulas-socity/android.widget.TextView - Part Test'), 0)

Mobile.tap(findTestObject('Object Repository/aulas-socity/android.view.ViewGroup (5)'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Object Repository/aulas-socity/android.widget.TextView - (2)'), 0)

Mobile.pressBack()

Mobile.takeScreenshot('C:\\Users\\user\\AppData\\Local\\Temp\\screenshot2805205888099162698.png')
...
Mobile.tap(findTestObject('Object Repository/aulas-socity/android.view.ViewGroup (6)'), 0)

Mobile.tap(findTestObject('Object Repository/aulas-socity/android.widget.TextView - LOG OUT'), 0)
